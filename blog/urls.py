...
from .views import HomeView,ArticleDetailView,AddCategoryView,UpdatePostView, DeletePostView,  CategoryView, CategoryListView, searched_post, addpost, LikeView, AddCommentView
